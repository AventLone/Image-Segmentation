...
# logging.debug("Hello! This is a logging test.")
# logging.info("Hello! This is a logging test.")
# logging.warning("Hello! This is a logging test.")
# logging.error("Hello! This is a logging test.")
# logging.critical("Hello! This is a logging test.")
