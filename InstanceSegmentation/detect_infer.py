...
model = RFDETRMedium(pretrain_weights="output/RFDETRMedium/2026-05-25-112715/checkpoint_best_total.pth", num_queries=100)

model.optimize_for_inference()
image = Image.open("/home/linde/Downloads/image_2.png").convert("RGB")
